...
class AppDecoration {
//    static BoxDecoration get choosePlan => BoxDecoration(
...
//   static BoxDecoration get lightGreyElevation => BoxDecoration(
//         color: ColorConstant.white,
//         boxShadow: [
//           BoxShadow(
...
//   static BoxDecoration get cta3 => BoxDecoration(
...
//       );
//   static BoxDecoration get secondaryColor => BoxDecoration(
...
//   static BoxDecoration get errorTwo => BoxDecoration(
//         color: ColorConstant.errorTwo,
//       );

//   static BoxDecoration get fillsecondaryLight => BoxDecoration(
...
//   static BoxDecoration get whiteFill => BoxDecoration(
//         color: ColorConstant.white,
//       );
...
//   static BoxDecoration get lime => BoxDecoration(
//         color: ColorConstant.lime,
//       );
//   static BoxDecoration get lightSuccess => BoxDecoration(
//         color: ColorConstant.lightSuccess,
//       );
//   static BoxDecoration get fillsuccess => BoxDecoration(
//         color: ColorConstant.success,
//       );
//   static BoxDecoration get fillcta => BoxDecoration(
//         color: ColorConstant.cta,
//       );
//   static BoxDecoration get fillbgGrey => BoxDecoration(
//         color: ColorConstant.bgGrey,
//       );
//   static BoxDecoration get fillsecondaryColor => BoxDecoration(
//         color: ColorConstant.secondaryColor,
//       );
//   static BoxDecoration get orangeTwo => BoxDecoration(
//         color: ColorConstant.orangeTwo,
//       );
...
//   static BoxDecoration get wallet => BoxDecoration(
//         gradient: LinearGradient(
//           begin: Alignment(
//             0,
//             0,
...
//   static BoxDecoration get txtFilllightSuccess => BoxDecoration(
//         color: ColorConstant.lightSuccess,
//       );
//   static BoxDecoration get txtFillorangeTwo => BoxDecoration(
//         color: ColorConstant.orangeTwo,
//       );
//   static BoxDecoration get fillGray400 => BoxDecoration(
//         color: ColorConstant.ctaUnactive,
//       );
//   static BoxDecoration get fillRedbtn => BoxDecoration(
//         color: ColorConstant.cta,
//       );
...
//   //!
//   ///created by manisha
//   static BoxDecoration get healthCardBackColor => BoxDecoration(
//         gradient: LinearGradient(
//           begin: Alignment.topLeft,
...
//   static BoxDecoration get medGoldCardBackDecor => BoxDecoration(
...
//   static BoxDecoration get whiteBgGreyElevation => BoxDecoration(
//         color: ColorConstant.white,
//         boxShadow: [
//           BoxShadow(
//             color: ColorConstant.bgGrey,
...
//         ),
//       );
//   static BoxDecoration get neutral20 => BoxDecoration(
...
//       ),
//       borderRadius: BorderRadiusStyle.roundedBorder3);
//   static BoxDecoration get fillSec50 => BoxDecoration(
//         color: ColorConstant.secondary50,
//       );
