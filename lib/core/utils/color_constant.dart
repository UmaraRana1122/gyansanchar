...
//  Color h = Vx.hexToColor("#");
  ...
  static const poppinsblack1 = Color(0xFF212525);
  static const ralewayblack1 = Color(0xFF000000);

  static const grey11 = Color(0xFFBCC1CD);
  static const yellow1 = Color(0xFFEBB12B);
  static const grey1 = Color(0xff8A90A2);
  ...
  static const blueGrey = Color(0xFF545567);
  static const skyBlue = Color(0xFF23BDEE);
  static const greyBlack = Color(0xFF1B1918);
  static const blueGreyOne = Color(0xFF636D77);
  static const darkBlueGrey = Color(0xFF364356);
  static const whiteRed = Color(0xFFEDEDED);
  static const whiteRedOne = Color(0xFFE6E6E6);
  static const yellowTwo = Color.fromARGB(255, 240, 84, 84);
  static const purple = Color(0xFF786FE9);
  static const white = Color(0xFFFFFFFF);

  static const dark = Color(0xFF0D173B);
  static const orangeOne = Color(0xFFF07C00);
